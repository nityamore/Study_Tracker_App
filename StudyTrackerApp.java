...
class StudyTracker
{
    ...
    public void InsertLog()
    {
        ...
        System.out.println("-------------------------------------------------------");
        System.out.println("------------Enter valid details of ypur study----------");
        System.out.println("-------------------------------------------------------");
        ...
        StudyLog studyobj = new StudyLog(Dateobj, sub, dur, dest);

        Database.add(studyobj);

        System.out.println("Study log gets stored successfuly");
        System.out.println("---------------------------------------------------------");
...
class MarvellousStudyTracker
{
    public static void main(String A[])
    {
        ...
        do
        {
            ...
            System.out.println("4 : Summary of Study log by data");
            System.out.println("5 : Summary of Study lig by subject");
            ...
            switch(iChoice)
            {
                ...
                case 6 :
                    System.out.println("--------------------------------------------------------");
                    System.out.println("---------Thankyou for Marvellous StudyTracker-----------");
                    System.out.println("--------------------------------------------------------");
                    break;
